...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 13:11:56 2019
...
df = pd.read_csv('MyExpt_Cells_G2_TVPmutAB.txt', delimiter = '\t')
...
export_excel = df.to_excel(r'/Users/zdaruwala/Documents/confocal images/06072019/cellprofiler data/G2 and TVPmutAB cell data.xlsx', index = None, header=True) 

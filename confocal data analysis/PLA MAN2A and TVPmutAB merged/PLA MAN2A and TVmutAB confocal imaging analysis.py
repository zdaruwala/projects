...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 13:16:51 2019
...
df = pd.read_csv('MyExpt_cells_MAN2A_TVPmutAB.txt', delimiter = '\t')
...
export_excel = df.to_excel(r'/Users/zdaruwala/Documents/confocal images/06072019/cellprofiler data/MAN2A and TVPmutAB cell data.xlsx', index = None, header=True) 

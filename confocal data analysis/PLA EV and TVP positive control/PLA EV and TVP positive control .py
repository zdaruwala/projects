...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 12:23:15 2019
...
df = pd.read_csv('MyExpt_Cells_EV_TVP.txt', delimiter = '\t')
...
export_excel = df.to_excel(r'/Users/zdaruwala/Documents/confocal images/06072019/cellprofiler data/EV and TVP positive control cell data.xlsx', index = None, header=True) 

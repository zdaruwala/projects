...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 12:32:41 2019
...
df = pd.read_csv('MyExpt_cells_G0mutC_TVP.txt', delimiter = '\t')
...
export_excel = df.to_excel(r'/Users/zdaruwala/Documents/confocal images/06072019/cellprofiler data/G0mutC and TVP cell data.xlsx', index = None, header=True) 
